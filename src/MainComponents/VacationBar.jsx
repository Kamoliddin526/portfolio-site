  ...
  const items = [
    <Fade top>
      <div className="card" data-value="1">
        <img src={Bali} alt="" />
        <h1 className="cardTitle">Bali, Indonesia</h1>
      </div>
    </Fade>,
    <Fade top>
      <div className="card" data-value="2">
        <img src={Kerry} alt="" />
        <h1 className="cardTitle">Kerry, Ireland</h1>
      </div>
      ,
    </Fade>,
    ...
    <Fade top>
      <div className="card" data-value="3">
        <img src={Sydney} alt="" />
        <h1 className="cardTitle">Sydney, Australia</h1>
      </div>
      ,
    </Fade>,
    ...
    <Fade top>
      <div className="card" data-value="4">
        <img src={Paris} alt="" />
        <h1 className="cardTitle">Paris, France</h1>
      </div>
      ,
    </Fade>,
  ];
