              ...
              d="M22.1843 11.8444L12.5302 2.19731C12.4607
                                      ...
                                      1.99701 12.0989 1.9776 12.0005 1.9776C11.9021 1.9776
                                       ...
                                       12.1257 1.37598 12.5077 1.37598 12.9062C1.37598 13.7336
                                        ...
                                        14.2492 22.1867 13.9656C22.7703 13.3796 22.7703 12.4304 22.1843 11.8444Z"
              fill="#2659C3"
            />
          </g>
        </svg>
          ...
          <defs>
            <clipPath id="clip0_1_4218">
              <rect
                ...
                height="24.0006"
                fill="white"
                transform="translate(0.501221 0.00817871)"
              />
            </clipPath>
          </defs>
        </svg>
      ...
      <Link to={"/page_2"} className="icon-media">
        ...
        >
          <g id="ri:hotel-fill">
            <path
              id="Vector"
              d="M17.0027 19.0089H19.0028V11.0086H13.0025V19.0089H15.0026V13.0087H17.0027V19.0089ZM3.00212 19.0089V4.00828C3.00212 3.74305 3.10748 3.48869 3.29502 3.30115C3.48257 3.1136 3.73693 3.00824 4.00216 3.00824H18.0028C18.268 3.00824 18.5223 3.1136 18.7099 3.30115C18.8974 3.48869 19.0028 3.74305 19.0028 4.00828V9.00849H21.0029V19.0089H22.0029V21.009H2.00208V19.0089H3.00212ZM7.00229 11.0086V13.0087H9.00237V11.0086H7.00229ZM7.00229 15.0087V17.0088H9.00237V15.0087H7.00229ZM7.00229 7.00841V9.00849H9.00237V7.00841H7.00229Z"
              fill="#2659C3"
            />
          </g>
        </svg>
      ...
      <Link to={"/page_2"} className="icon-media">
        ...
        >
          <g id="ic:baseline-flight">
            <path
              id="Vector"
              d="M19.7675 15.4882V13.7485L12.8084 9.39901V4.61462C12.8084 3.89261 12.2256 3.30978 11.5036 3.30978C10.7816 3.30978 10.1987 3.89261 10.1987 4.61462V9.39901L3.23962 13.7485V15.4882L10.1987 13.3135V18.0979L8.45896 19.4027V20.7076L11.5036 19.8377L14.5482 20.7076V19.4027L12.8084 18.0979V13.3135L19.7675 15.4882Z"
              fill="#2659C3"
              stroke="#2659C3"
